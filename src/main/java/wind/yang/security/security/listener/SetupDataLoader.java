package wind.yang.security.security.listener;
...
import wind.yang.security.domain.entity.*;
import wind.yang.security.repository.*;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void setupSecurityResources() {
        ...
        createUserIfNotFound("admin", "admin@admin.com", "admin", roles);
